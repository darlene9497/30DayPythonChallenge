...
# Two Parameters: A function may or may not have a parameter or parameters. A function may also have two or more parameters. If our function takes parameters we should call it with arguments. Let us check a function with two parameters:
  # syntax
  # Declaring a function
...
def name(firstname):
    return firstname
print(name('Asabeneh')) # Asabeneh

def full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print(full_name(firstname='Asabeneh', lastname='Yetayeh'))
